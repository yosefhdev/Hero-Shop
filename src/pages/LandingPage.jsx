			...
			<nav id="menu-h" className="max-w-7xl mx-auto min-h-16 bg-black">
				...
				<div class="w-full mx-auto text-left md:w-3/5 lg:w-2/5 md:text-center">
					...
					“¡Bienvenidos a Hero-shop! Somos una tienda especializada en playeras estampadas.”
						...
						<a href="https://www.facebook.com/HeroShop.15/about"><p class="mb-6 text-xs  tracking-widest text-purple-900 ">Facebook</p></a>
	...
	<section id="banner" className="max-w-7xl mx-auto min-h-[150px] bg-blue-900  overflow-hidden relative">
		...
		{/* Separador de pagina */}
			...
			{/* Productos */}
				...
				{/*Questions*/}
				<section class="px-4 py-24 mx-auto max-w-7xl">
					<h2 class="mb-4 text-xl font-bold md:text-3xl">Preguntas Mas Recientes</h2>
					<div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
						<div>
						<h5 class="mt-10 mb-3 font-semibold text-gray-900">Quienes somos?</h5>
						<p>
							HeroShop vende una amplia gama de ropa urbana y casual, desde camisetas y sudaderas hasta pantalones y accesorios.
						</p>
						<h5 class="mt-10 mb-3 font-semibold text-gray-900">HeroShop ofrece tallas para todas las personas?</h5>
						...
						<h5 class="mt-10 mb-3 font-semibold text-gray-900">Qué tipo de promociones o descuentos ofrece HeroShop?</h5>
						<p>
						...
						<h5 class="mt-10 mb-3 font-semibold text-gray-900">Qué diferencia a HeroShop de otras tiendas de ropa?</h5>
						<p>
						...
						<h5 class="mt-10 mb-3 font-semibold text-gray-900">HeroShop tiene alguna política de devolución o cambio?</h5>
						...
						<div>
						<h5 class="mt-10 mb-3 font-semibold text-gray-900">Cómo puedo estar al tanto de las últimas novedades y lanzamientos de productos de HeroShop?</h5>
						<p>
			...
			<footer class="flex flex-col items-center justify-between px-4 py-12 mx-auto max-w-7xl md:flex-row">
					<p class="mb-8 text-sm text-center text-gray-700 md:text-left md:mb-0">© Copyright 2024 Hero Shop  Derechos Reservados   </p>
					...
					<div class="flex items-center space-x-6">
						...
						<svg xmlns="https://www.facebook.com/HeroShop.15/about" width="1298" height="2500" viewBox="88.428 12.828 107.543 207.085" class="w-5 h-5" aria-hidden="true">
							<path
